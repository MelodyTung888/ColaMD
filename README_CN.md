...
昨天发布 v1.7.3 后，我们收到了社区的反馈。今天的 v1.7.4，就把这些反馈变成了一组更顺手的 Markdown 工作流。感谢大家提交 Issue、Pull Request，以及参与测试、反馈和讨论的每一位朋友。ColaMD 还在继续成长，欢迎下载体验，也欢迎告诉我们你希望它变成什么样。
...
- **文件列表面板** — 浏览当前目录和子目录中的 Markdown 文件；没有打开文件时默认展示「文稿」目录，Agent 新建或删除文件后自动更新。
- **源码模式** — 需要查看或直接修改原始 Markdown 时，一键切换源码编辑。
- **Mermaid 图表** — 在 Mermaid 代码块中直接渲染流程图、时序图等图表。
...
- v1.7.4 — 根据社区反馈完善文件面板、源码模式、Mermaid 图表、HTML 导出、Windows 图片路径，并提供 VS Code 集成 MVP
